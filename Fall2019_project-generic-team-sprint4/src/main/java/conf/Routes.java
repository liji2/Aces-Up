...
public class Routes implements ApplicationRoutes {
    ...
    public void init(Router router) {  
        ...
        //router.POST().route("/switchDeck").with(ApplicationController.class, "switchDeck"); might need this later on

        // SPANISH route
        router.GET().route("/gameSpanish").with(ApplicationController.class, "gameGetSpanish");
        router.POST().route("/resetGameSpanish").with(ApplicationController.class, "resetGameSpanish");
